...
class ClinicFilterAppbar extends StatefulWidget implements PreferredSizeWidget {
//const MyAppBar({Key? key}) : super(key: key);
  bool isback;
  // HomeAppBar(required this.isback) : super();
  ClinicFilterAppbar({required this.isback}) : super();
  //bool isback = false;
...
class _AppBarState extends State<ClinicFilterAppbar> {
