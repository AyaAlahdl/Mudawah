...
class ClinicAppBar extends StatefulWidget implements PreferredSizeWidget {
//const MyAppBar({Key? key}) : super(key: key);
  bool isback;
  // HomeAppBar(required this.isback) : super();
  ClinicAppBar({required this.isback}) : super();
  //bool isback = false;
...
class _AppBarState extends State<ClinicAppBar> {
    ...
    return PreferredSize(
      ...
      child: Padding(
        ...
        child: GetBuilder<HospitalController>(
          builder: (doctorController) => Container(
            height: 62,
            child: TextField(
              controller: mSearchContrller,
              onChanged: (Value) {
                doctorController.searchClinicListItems(Value);
              },
