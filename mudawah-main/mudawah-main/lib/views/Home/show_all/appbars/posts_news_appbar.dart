...
class PostNewsAppBar extends StatefulWidget implements PreferredSizeWidget {
//const MyAppBar({Key? key}) : super(key: key);
  bool isback;
  // HomeAppBar(required this.isback) : super();
  PostNewsAppBar({required this.isback}) : super();
  //bool isback = false;
...
class _AppBarState extends State<PostNewsAppBar> {
        ...
        child: GetBuilder<PostsController>(
          builder: (hospitalController) => Container(
            ...
            child: TextField(
              ...
              onChanged: (Value) {
                hospitalController.searchRecentPostsListItems(Value);
              },
