...
class PostHeightAppBar extends StatefulWidget implements PreferredSizeWidget {
//const MyAppBar({Key? key}) : super(key: key);
  bool isback;
  // HomeAppBar(required this.isback) : super();
  PostHeightAppBar({required this.isback}) : super();
  //bool isback = false;
...
class _AppBarState extends State<PostHeightAppBar> {
        ...
        child: GetBuilder<PostsController>(
          builder: (hospitalController) => Container(
            ...
            child: TextField(
              ...
              onChanged: (Value) {
                hospitalController.searchPostsHightListItems(Value);
              },
